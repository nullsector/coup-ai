...
(defun block-move (move player game source &optional target)
	(cond
		((= (game-rounds game) 1) () ; round 1 do nothing
		((< (game-rounds game) 1) ((coup::random-elem (coup::block-cards move)) ; ran block on round 2
		(t ( )) ; find out some thing for this state
)
